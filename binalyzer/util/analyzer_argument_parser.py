...
class AnalyzerArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self, *args, **kwargs):
        ...
        binalyzer_arg_group.add_argument('--root_dir', help='The root directory from where the search for analysis targets will start. (mutually exclusive with elf_list_file)')
        binalyzer_arg_group.add_argument('--elf_list_file', help='A file containing a list of strings specifying the file names of the analysis targets. (mutually exclusive with root_dir)')
