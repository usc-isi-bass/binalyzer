...
from cfg_statistics_analysis import CfgStatisticsAnalysis

def main():
    analyzer_argument_parser = ParallelAnalyzerArgumentParser()

    parser = argparse.ArgumentParser('Build CFG and extract some statistics', parents=[analyzer_argument_parser])
    ...
    analysis = CfgStatisticsAnalysis(cached_results_path=cached_results_path)
