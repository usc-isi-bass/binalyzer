...
def main():
    ...
    parser = argparse.ArgumentParser('Search for cryptographic hash functions by searching for their constants', parents=[analyzer_argument_parser])
    ...
    analysis = CryptoHashDetectionAnalysis(cached_results_path=cached_results_path)
