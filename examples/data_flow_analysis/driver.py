...
from data_flow_analysis import DataFlowAnalysis

def main():
    analyzer_argument_parser = ParallelAnalyzerArgumentParser()
    parser = argparse.ArgumentParser('Count the number of memory access operations in binaries.', parents=[analyzer_argument_parser])
    ...
    analysis = DataFlowAnalysis(cached_results_path=cached_results_path)
